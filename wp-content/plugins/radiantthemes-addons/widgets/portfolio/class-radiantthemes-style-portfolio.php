	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					'three'    => esc_html__( 'Style One', 'radiantthemes-addons' ),
					'five'     => esc_html__( 'Style Two', 'radiantthemes-addons' ),
					'eight'    => esc_html__( 'Style Three', 'radiantthemes-addons' ),
					'nine'     => esc_html__( 'Style Four', 'radiantthemes-addons' ),
					'ten'      => esc_html__( 'Style Five', 'radiantthemes-addons' ),
					'eleven'   => esc_html__( 'Style Six', 'radiantthemes-addons' ),
					'twelve'   => esc_html__( 'Style Seven', 'radiantthemes-addons' ),
					'thirteen' => esc_html__( 'Style Eight', 'radiantthemes-addons' ),
					'fourteen' => esc_html__( 'Style Nine', 'radiantthemes-addons' ),
					'sixteen'  => esc_html__( 'Style Ten', 'radiantthemes-addons' ),
				),
				'default'     => 'eight',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .rt-portfolio-box .rt-portfolio-box-item >  .data .title a',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .rt-portfolio-box .rt-portfolio-box-item > .data .categories span',
			)
		);
