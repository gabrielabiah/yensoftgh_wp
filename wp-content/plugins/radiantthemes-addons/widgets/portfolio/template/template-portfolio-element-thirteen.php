...
$output .= '<div class=" rt-portfolio-box element-therteen">';
...
if ( $my_query->have_posts() ) {
    ...
    $output .= '<div class="rt-image-box">';
    $output .= '<a href="'.esc_url( get_permalink() ).'"><img src="' . get_the_post_thumbnail_url( get_the_ID(), 'full' ) . '"></a>';
   $output .= '</div>';
    $output .= '<div class="radiant_lifestyle_section_two-col">';
	$output .= '<div class="radiant-masonory-date">';
