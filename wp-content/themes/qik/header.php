	...
	<?php } ?>
		...
		<header class="wraper_header">
			...
			if ( ! class_exists( 'Redux' ) ) {
				?>
			<?php } elseif ( is_404() || is_search() || is_shop() || is_tax( 'product_cat' ) || is_tax( 'product_tag' ) || is_singular( 'product' ) || is_home() || is_category() || is_archive() || is_tag() || is_author() || is_attachment() || is_singular( 'post' ) ) { ?>
				<?php
			...
			} elseif ( is_404() || is_search() || is_shop() || is_tax( 'product_cat' ) || is_tax( 'product_tag' ) || is_singular( 'product' ) || is_home() || is_category() || is_archive() || is_tag() || is_author() || is_attachment() || is_singular( 'post' ) ) {
